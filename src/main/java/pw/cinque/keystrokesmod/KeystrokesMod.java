...
public class KeystrokesMod {
    ...
    private void buildKeyHolder() {
        ...
        keyHolder = new KeyHolder.Builder(this).setWidth(82).setGapSize(2).addRow(none, keyW, none).addRow(keyA, keyS, keyD).addRow(leftMouse, rightMouse).addRow(keySpaceBar).build();
    }
